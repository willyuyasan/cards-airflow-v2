...
mysql -u {{params.MYSQL_DB_USER}} -p {{params.MYSQL_DB_PASS}} -h {{params.MYSQL_DBHOST}} -AN -e"{SQL}" > {{params.DUMP_FILEPATH}}/arp_dim_refresh.sql

# connect to Postgresql to load the data dumped in the previous step
export PGPASSWORD={{params.PGSQL_DB_PASS}}
psql -h {{params.PGSQL_DBHOST}} -d {{params.PGSQL_DB}} -U {{params.PGSQL_DB_USER}} -f {{params.DUMP_FILEPATH}}/arp_dim_refresh.sql -o {{params.DUMP_FILEPATH}}/arp_dim_affiliates_refresh_out.log

rm {{params.DUMP_FILEPATH}}/arp_dim_refresh.sql
...
# connect to Postgresql to load the data dumped in the previous step
export PGPASSWORD={{params.PGSQL_DB_PASS}}
psql -h {{params.PGSQL_DBHOST}} -d {{params.PGSQL_DB}} -U {{params.PGSQL_DB_USER}} -f {{params.DUMP_FILEPATH}}/arp_dim_refresh.sql -o {{params.DUMP_FILEPATH}}/arp_dim_websites_refresh_out.log
...
# connect to Postgresql to load the data dumped in the previous step
export PGPASSWORD={{params.PGSQL_DB_PASS}}
psql -h {{params.PGSQL_DBHOST}} -d {{params.PGSQL_DB}} -U {{params.PGSQL_DB_USER}} -f {{params.DUMP_FILEPATH}}/arp_dim_refresh.sql -o {{params.DUMP_FILEPATH}}/arp_dim_categories_refresh_out.log

rm {{params.DUMP_FILEPATH}}/arp_dim_refresh.sql

# housekeeping
rm {{params.DUMP_FILEPATH}}/arp_dim_affiliates_refresh_out.log
rm {{params.DUMP_FILEPATH}}/arp_dim_websites_refresh_out.log
rm {{params.DUMP_FILEPATH}}/arp_dim_categories_refresh_out.log
