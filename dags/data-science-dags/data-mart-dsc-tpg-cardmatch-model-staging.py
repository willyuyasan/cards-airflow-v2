...
ACCOUNT = 'cards'
DAG_NAME = 'data-mart-dsc-tpg-cardmatch-model-staging'
...
model_deployment_notebook_task = {
    ...
    'notebook_path': '/Projects/CardMatch/TPG/TPG-CardMatch_python_combine',
}

# DAG Creation Step
with DAG('data-mart-dsc-tpg-cardmatch-model-staging',
