...
cfg_dict = dh.read_config_file('aws-redshift-maintenance-vacuum-weekly.cfg')
...
dag = DAG('dw-maintenance-full-vacuum',
...
full_vacuum_table_task = PythonOperator(
    task_id='full_vacuum_table',
    python_callable=dh.execute_pipeline,
    dag=dag)

full_vacuum_table_task.set_upstream(latest_only)
