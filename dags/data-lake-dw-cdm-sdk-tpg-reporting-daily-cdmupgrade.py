...
ACCOUNT = 'cards'
DAG_NAME = 'data-lake-dw-cdm-sdk-tpg-reporting-daily-cdmupgrade'
...
reporting_libraries = [
    ...
    {
        "jar": "dbfs:/FileStore/jars/91a7a8b7_f582_4fc0_b3c7_14e7f5f143fe-cdm_data_mart_cards_assembly_0_0_1_SNAPSHOT-97c7e.jar",
    }
]
...
with DAG(DAG_NAME,
    ...
    attribution_reporting = FinServDatabricksSubmitRunOperator(
        ...
        new_cluster=large_15w_task_cluster,
