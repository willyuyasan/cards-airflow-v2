...
ACCOUNT = 'cards'
DAG_NAME = 'data-mart-dsc-comb-cardmatch-shadow-model-monthly'
...
wells_fargo_model_training_notebook_task = {
    'base_parameters': {
        "issuer": "Wells Fargo",
        "card_ids": "7683, 7684, 7685, 7730, 7731, 7878, 7879, 8010, 8011"
    },
    'notebook_path': '/Production/CardMatchDS/Combined/CardMatch_python_train-shadow',
}
...
oopfi_model_training_notebook_task = {
    'base_parameters': {
        "issuer": "Oopfi",
        "card_ids": "8056"
    },
...
model_deployment_notebook_task = {
    'base_parameters': {
        "environment": "staging",
        "notebook": '/Production/CardMatchDS/Combined/CardMatch_python_combine-shadow'
    },
    'notebook_path': '/Production/CardMatchDS/Combined/CardMatch_python_combine-shadow',
}

# DAG Creation Step
with DAG('data-mart-dsc-comb-cardmatch-shadow-model-monthly',
    ...
    oopfi_model_training_step = FinServDatabricksSubmitRunOperator(
        task_id='Oopfi-model-training-step',
        new_cluster=small_task_cluster,
        notebook_task=oopfi_model_training_notebook_task,
        libraries=model_step_libraries,
        timeout_seconds=3600,
        databricks_conn_id=airflow_svc_token,
        polling_period_seconds=120
