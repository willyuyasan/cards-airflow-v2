...
default_args = {
    ...
    'on_failure_callback': slack_hook.slack_failure_callback(),
    'retries': 1,
...
# DAG Creation Step
with DAG('cards-dw-cdm-sdk-cards-staging-hourly',
...
[page_view_staging, page_metrics_staging, product_clicked_staging, product_viewed_staging, element_clicked_staging, element_viewed_staging, cookie_identified_staging, field_inputted_staging, device_staging, location_staging, decsion_staging, traffic_sources_staging, form_submitted_staging] >> tpg_staging_tables
