...
ACCOUNT = 'cards'
DAG_NAME = 'data-mart-dsc-tpg-cardmatch-shadow-model-staging'
...
etl_notebook_task = {
    ...
    'notebook_path': '/Projects/CardMatch/TPG/TPG-CM-data',
}
...
avant_model_training_notebook_task = {
    ...
    'notebook_path': '/Projects/CardMatch/TPG/TPG-CardMatch_python_train-shadow',
}
...
model_deployment_notebook_task = {
    'base_parameters': {
        "environment": "staging",
        "notebook": '/Projects/CardMatch/TPG/TPG-CardMatch_python_combine'
    },
    'notebook_path': '/Projects/CardMatch/TPG/TPG-CardMatch_python_combine-shadow',
}

# DAG Creation Step
with DAG('data-mart-dsc-tpg-cardmatch-shadow-model-staging',
