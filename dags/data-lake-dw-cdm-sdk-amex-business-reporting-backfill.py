...
conversion_reporting_jar_task = {
    ...
    'parameters': [
        ...
        "START_DATE=" + (
            datetime.strptime(Variable.get("AMEX_BUSINESS_BACKFILL_LOOKBACK_TODATE"), "%Y-%m-%d") - (timedelta(days=int(int(Variable.get("AMEX_BUSINESS_BACKFILL_LOOKBACK_DAYS")))))).strftime(
            "%Y-%m-%d"),
