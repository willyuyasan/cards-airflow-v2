...
ACCOUNT = 'cards'
DAG_NAME = 'data-mart-dsc-ccdc-cardmatch-shadow-model-monthly'
...
avant_model_training_notebook_task = {
    ...
    'notebook_path': '/Production/CardMatchDS/CCDC/CardMatch_python_train-shadow',
}
...
model_deployment_notebook_task = {
    'base_parameters': {
        "environment": "staging",
        "notebook": '/Production/CardMatchDS/CCDC/CardMatch_python_combine-shadow'
    },
    'notebook_path': '/Production/CardMatchDS/CCDC/CardMatch_python_combine-shadow',
}

# DAG Creation Step
with DAG('data-mart-dsc-ccdc-cardmatch-shadow-model-monthly',
