...
FILEPATH=/home/airflow/
SCHEMATODUMP=cardcatalog
DBUSER=u_cardcatalog_sch
...
EXTBLIST=`psql -U ${DBUSER} --host {{params.dbhost}} --port 5432 -d {{params.db}} -t -c "${SQL}"`
...
SQL="${SQL} group by schemaname;"
INCLUDETBLIST=`psql -U ${DBUSER} --host {{params.dbhost}} --port 5432 -d {{params.db}} -t -c "${SQL}"`
...
psql -U ${DBUSER} --host {{params.dbhost}} --port 5432 -d {{params.db}} -t -c "${SQL}" -o ${FILEPATH}${SCHEMATODUMP}_copy_tb_data_to_csv_file.sql
...
SQL="${SQL} from pg_tables where schemaname = '${SCHEMATODUMP}' and tablename in ( ${INCLUDETBLIST} ) Order by tablename;"
psql -U ${DBUSER} --host {{params.dbhost}} --port 5432 -d {{params.db}} -t -c "${SQL}" -o ${FILEPATH}${SCHEMATODUMP}_copy_tb_data_from_csv_file.sql

# actual dumping
psql -U ${DBUSER} --host {{params.dbhost}} --port 5432 -d {{params.db}} -q -f ${FILEPATH}${SCHEMATODUMP}_copy_tb_data_to_csv_file.sql
...
psql -U ${DBUSER} --host {{params.dbhost_to}} --port 5432 -d {{params.db_to}} -t -c "${SQL}" -o ${FILEPATH}${SCHEMATODUMP}_drop_fk.sql
...
psql -U ${DBUSER} --host {{params.dbhost_to}} --port 5432 -d {{params.db_to}} -t -c "${SQL}" -o ${FILEPATH}${SCHEMATODUMP}_add_fk.sql
...
psql -U ${DBUSER} --host {{params.dbhost_to}} --port 5432 -d {{params.db_to}} -t -c "${SQL}" -o ${FILEPATH}${SCHEMATODUMP}_truncate.sql


# actual refresh steps

psql -U ${DBUSER} --host {{params.dbhost_to}} --port 5432 -d {{params.db_to}} -q -f ${FILEPATH}${SCHEMATODUMP}_drop_fk.sql
psql -U ${DBUSER} --host {{params.dbhost_to}} --port 5432 -d {{params.db_to}} -q -f ${FILEPATH}${SCHEMATODUMP}_truncate.sql
psql -U ${DBUSER} --host {{params.dbhost_to}} --port 5432 -d {{params.db_to}} -q -f ${FILEPATH}${SCHEMATODUMP}_copy_tb_data_from_csv_file.sql
psql -U ${DBUSER} --host {{params.dbhost_to}} --port 5432 -d {{params.db_to}} -q -f ${FILEPATH}${SCHEMATODUMP}_add_fk.sql


#fix the sequence issue - going out of sync
psql -U ${DBUSER} --host {{params.dbhost_to}} --port 5432 -d {{params.db_to}} -t -c "truncate table public.cardcatalog_seq_verify;"
...
psql -U ${DBUSER} --host {{params.dbhost_to}} --port 5432 -d {{params.db_to}} -t -c "${SQL}" -o ${FILEPATH}${SCHEMATODUMP}_sequence_verify_get.sql
psql -U ${DBUSER} --host {{params.dbhost_to}} --port 5432 -d {{params.db_to}} -q -f ${FILEPATH}${SCHEMATODUMP}_sequence_verify_get.sql
...
psql -U ${DBUSER} --host {{params.dbhost_to}} --port 5432 -d {{params.db_to}} -t -c "${SQL}" -o ${FILEPATH}${SCHEMATODUMP}_sequence_set_exec.sql
psql -U ${DBUSER} --host {{params.dbhost_to}} --port 5432 -d {{params.db_to}} -q -f ${FILEPATH}${SCHEMATODUMP}_sequence_set_exec.sql
...
psql -U ${DBUSER} --host {{params.dbhost_to}} --port 5432 -d {{params.db_to}} -t -c "${SQL}" -o ${FILEPATH}${SCHEMATODUMP}_sequence_verify_upd.sql
psql -U ${DBUSER} --host {{params.dbhost_to}} --port 5432 -d {{params.db_to}} -q -f ${FILEPATH}${SCHEMATODUMP}_sequence_verify_upd.sql
