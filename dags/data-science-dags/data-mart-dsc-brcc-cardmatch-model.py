...
ACCOUNT = 'cards'
DAG_NAME = 'data-mart-dsc-brcc-cardmatch-model-monthly'
...
avant_model_training_notebook_task = {
    ...
    'notebook_path': '/Production/CardMatchDS/BRCC/BRCC-CardMatch_python_train',
}
...
icommissions_model_training_notebook_task_c = {
    ...
    'notebook_path': '/Production/CardMatch/BRCC/BRCC-CardMatch_python_train',
}
...
model_deployment_notebook_task = {
    'base_parameters': {
        "environment": "staging",
        "notebook": '/Production/CardMatchDS/BRCC/BRCC-CardMatch_python_combine'
    },
    'notebook_path': '/Production/CardMatchDS/BRCC/BRCC-CardMatch_python_combine',
}

# DAG Creation Step
with DAG('data-mart-dsc-brcc-cardmatch-model-monthly',
