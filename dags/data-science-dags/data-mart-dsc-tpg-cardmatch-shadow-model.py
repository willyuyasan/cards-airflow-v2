...
ACCOUNT = 'cards'
DAG_NAME = 'data-mart-dsc-tpg-cardmatch-shadow-model-monthly'
...
model_deployment_notebook_task = {
    'base_parameters': {
        "environment": "staging",
        "notebook": '/Production/CardMatchDS/TPG/TPG-CardMatch_python_combine-shadow'
    },
    'notebook_path': '/Production/CardMatchDS/TPG/TPG-CardMatch_python_combine-shadow',
}

# DAG Creation Step
with DAG('data-mart-dsc-tpg-cardmatch-shadow-model-monthly',
