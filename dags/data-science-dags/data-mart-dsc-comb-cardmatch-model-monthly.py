...
ACCOUNT = 'cards'
DAG_NAME = 'data-mart-dsc-comb-cardmatch-model-monthly'
...
model_deployment_notebook_task = {
    'base_parameters': {
        "environment": "staging",
        "notebook": '/Production/CardMatchDS/Combined/CardMatch_python_combine'
    },
    'notebook_path': '/Production/CardMatchDS/Combined/CardMatch_python_combine',
}

# DAG Creation Step
with DAG('data-mart-dsc-comb-cardmatch-model-monthly',
