...
ACCOUNT = 'cards'
DAG_NAME = 'data-mart-dsc-ccdc-cardmatch-shadow-model-staging'
...
etl_notebook_task = {
    ...
    'notebook_path': '/Projects/CardMatch/CCDC/CardMatch_new_data_pull',
}
...
model_deployment_notebook_task = {
    'base_parameters': {
        "environment": "staging",
        "notebook": '/Projects/CardMatch/CCDC/CardMatch_python_combine-shadow'
    },
    'notebook_path': '/Projects/CardMatch/CCDC/CardMatch_python_combine-shadow',
}

# DAG Creation Step
with DAG('data-mart-dsc-ccdc-cardmatch-shadow-model-staging',
