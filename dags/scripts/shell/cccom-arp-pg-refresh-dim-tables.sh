...
MYSQL_DB_USER= {{params.MYSQL_DB_USER}}
MYSQL_DB_PASS={{params.MYSQL_DB_PASS}}
MYSQL_DBHOST={{params.MYSQL_DBHOST}}
DUMP_FILEPATH={{params.DUMP_FILEPATH}}
PGSQL_DBHOST={{params.PGSQL_DBHOST}}
PGSQL_DB={{params.PGSQL_DB}}
PGSQL_DB_USER={{params.PGSQL_DB_USER}}
PGSQL_DB_PASS={{params.PGSQL_DB_PASS}}
